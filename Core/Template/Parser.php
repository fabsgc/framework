...
class Parser {
    ...
    protected $markup = ['vars'      => ['{', '}', '}}', '}_}', '{{gravatar:', '{{php:', '{{url', '{{lang', '{_{url', '{_{lang', '{{path:'],  // vars
    ...
    protected function _parseExtends() {
        $this->_content = preg_replace_callback('`' . $this->_openTag . $this->_name . preg_quote($this->markup['extends'][0]) . $this->_spaceR . preg_quote($this->markup['extends'][1]) . $this->_space . '=' . $this->_space . '"([\.A-Za-z0-9_\->\$\/\{\}:\(\)\[\]\'\\\\]+)"' . $this->_space . '((' . preg_quote($this->markup['extends'][2]) . $this->_space . '=' . $this->_space . '"([0-9]*)"' . $this->_space . ')*)' . $this->_space . '/' . $this->_closeTag . '`isU', ['Gcs\Framework\Core\Template\Parser', '_parseExtendsCallback'], $this->_content);
    }
    ...
    protected function _parseExtend() {
        foreach (Template::$_extends as $extend) {
            $this->_content = $extend['class']::$extend['method']($this->_content);
        }

        foreach (Config::instance()->config['user']['template'] as $extend) {
            $this->_content = $extend['class']::$extend['method']($this->_content);
        }
    }
    ...
    protected function _parseInclude() {
        $this->_content = preg_replace_callback('`' . $this->_openTag . $this->_name . preg_quote($this->markup['include'][0]) . $this->_spaceR . preg_quote($this->markup['include'][1]) . $this->_space . '=' . $this->_space . '"([A-Za-z0-9_\-\$/]+)"' . $this->_space . '((' . preg_quote($this->markup['include'][2]) . $this->_space . '=' . $this->_space . '"([0-9]*)"' . $this->_space . ')*)' . $this->_space . '/' . $this->_closeTag . '`isU', ['Gcs\Framework\Core\Template\Parser', '_parseIncludeCallback'], $this->_content);
        $this->_content = preg_replace_callback('`' . $this->_openTag . $this->_name . preg_quote($this->markup['include'][0]) . $this->_spaceR . preg_quote($this->markup['include'][1]) . $this->_space . '=' . $this->_space . '"([A-Za-z0-9_\-\$/]+)"' . $this->_space . preg_quote($this->markup['include'][3]) . $this->_space . '=' . $this->_space . '"' . preg_quote($this->markup['include'][4]) . '"' . $this->_space . '((' . preg_quote($this->markup['include'][2]) . $this->_space . '=' . $this->_space . '"([0-9]*)"' . $this->_space . ')*)' . $this->_space . '/' . $this->_closeTag . '`isU', ['Gcs\Framework\Core\Template\Parser', '_parseIncludeCompileCallback'], $this->_content);
    }
    ...
    protected function _parseAsset() {
        $this->_content = preg_replace_callback('`' . $this->_openTag . $this->_name . preg_quote($this->markup['asset'][0]) . $this->_spaceR . preg_quote($this->markup['asset'][1]) . $this->_space . '=' . $this->_space . '"' . $this->_space . '(.+)' . $this->_space . '"' . $this->_spaceR . preg_quote($this->markup['asset'][2]) . $this->_space . '=' . $this->_space . '"' . $this->_space . '(.+)' . $this->_space . '"' . $this->_spaceR . preg_quote($this->markup['asset'][3]) . $this->_space . '=' . $this->_space . '"' . $this->_space . '(.+)' . $this->_space . '"' . $this->_space . '/' . $this->_closeTag . '`isU', ['Gcs\Framework\Core\Template\Parser', '_parseAssetCallback'], $this->_content);
    }
    ...
    protected function _parseForeach() {
        $this->_content = preg_replace(['`' . $this->_openTag . $this->_name . preg_quote($this->markup['foreach'][0]) . $this->_spaceR . preg_quote($this->markup['foreach'][1]) . $this->_space . '="' . $this->_space . '(.+)' . $this->_space . '"' . $this->_spaceR . preg_quote($this->markup['foreach'][2]) . $this->_space . '=' . $this->_space . '"(.+)' . $this->_space . '"' . $this->_space . $this->_closeTag . '`sU', '`' . $this->_openTag . '/' . $this->_name . preg_quote($this->markup['foreach'][0]) . $this->_space . $this->_closeTag . '`sU'], ['<?php foreach(\1 as \2) { ?>', '<?php } ?>'], $this->_content);
    }
    ...
    protected function _parseFor() {
        $this->_content = preg_replace(['`' . $this->_openTag . $this->_name . preg_quote($this->markup['for'][0]) . $this->_spaceR . preg_quote($this->markup['for'][1]) . $this->_space . '=' . $this->_space . '"' . $this->_space . '(.+)' . $this->_space . '"' . $this->_space . $this->_closeTag . '`sU', '`' . $this->_openTag . '/' . $this->_name . preg_quote($this->markup['for'][0]) . $this->_space . $this->_closeTag . '`sU'], ['<?php for($1) { ?>', '<?php } ?>'], $this->_content);
    }
    ...
    protected function _parseCondition() {
        $this->_content = preg_replace(['`' . $this->_openTag . $this->_name . preg_quote($this->markup['condition'][0]) . $this->_spaceR . preg_quote($this->markup['condition'][3]) . $this->_space . '=' . $this->_space . '"(.+)"' . $this->_space . $this->_closeTag . '`sU', '`' . $this->_openTag . '/' . $this->_name . preg_quote($this->markup['condition'][0]) . $this->_space . $this->_closeTag . '`sU', '`' . $this->_openTag . $this->_name . preg_quote($this->markup['condition'][1]) . $this->_spaceR . preg_quote($this->markup['condition'][3]) . '=' . $this->_space . '"(.+)"' . $this->_space . '/' . $this->_closeTag . '`sU', '`' . $this->_openTag . $this->_name . preg_quote($this->markup['condition'][2]) . $this->_space . '/' . $this->_closeTag . '`sU',], ['<?php if(\1) { ?>', '<?php } ?>', '<?php }elseif(\1){ ?>', '<?php }else{ ?>'], $this->_content);
    }
    ...
    protected function _parseAssetCallback($m) {
        if (Config::config()['user']['output']['asset']['enabled']) {
            $data = ['type' => $m[1], 'cache' => $m[3], 'files' => explode(',', $m[2])];
