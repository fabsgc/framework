...
class Facade {
    ...
    private static $_alias = [
        ...
        'Request'        => ['\Gcs\Framework\Core\Http\Request\Request', 'instance'],
        'Database'       => ['\Gcs\Framework\Core\Database\Database', 'instance'],
        'Response'       => ['\Gcs\Framework\Core\Http\Response\Response', 'instance'],
        'Profiler'       => ['\Gcs\Framework\Core\Profiler\Profiler', 'instance'],
        'RequestData'    => ['\Gcs\Framework\Core\Http\Request\Data', 'instance'],
