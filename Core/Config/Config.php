...
namespace Gcs\Framework\Core\Config;
...
class Config {
    ...
    private $_routeAttribute = [['name' => 'name', 'separator' => '.', 'concatenate' => true], ['name' => 'url', 'separator' => '', 'concatenate' => true], ['name' => 'action', 'separator' => '.', 'concatenate' => true], ['name' => 'vars', 'separator' => ',', 'concatenate' => true], ['name' => 'cache', 'separator' => '', 'concatenate' => false], ['name' => 'logged', 'separator' => '', 'concatenate' => false], ['name' => 'access', 'separator' => '', 'concatenate' => false], ['name' => 'method', 'separator' => '', 'concatenate' => false]];
    ...
    private $_langAttribute = [['name' => 'name', 'separator' => '.', 'concatenate' => true]];
                    ...
                    foreach ($this->config['lang'] as $key => $value) {
                        if ($key != 'app') {
                            foreach ($value as $key2 => $value2) {
                                $this->config['lang']['' . $key . '']['' . $key2 . ''] = array_merge($this->config['lang']['app']['' . $key2 . ''], $value2);
                            }
                        }
                    }
